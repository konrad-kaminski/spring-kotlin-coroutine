...
open class CoroutineMongoTemplate(
    ...
    override suspend fun createCollection(collectionName: String, collectionOptions: CollectionOptions): CoroutineMongoCollection<Document> =
    ...
    override suspend fun <O> aggregate(aggregation: TypedAggregation<*>, collectionName: String, outputType: Class<O>): List<O> =
    ...
    override suspend fun <O> aggregate(aggregation: Aggregation, collectionName: String, outputType: Class<O>): List<O> =
            reactiveMongoOperations.aggregate(aggregation, collectionName, outputType).collectList().awaitSingle()
    ...
    override suspend fun <T> geoNear(near: NearQuery, entityClass: Class<T>, collectionName: String): List<GeoResult<T>> =
    ...
    override suspend fun <T> findAndModify(query: Query, update: Update, entityClass: Class<T>, collectionName: String): T? =
            reactiveMongoOperations.findAndModify(query, update, entityClass, collectionName).awaitFirstOrDefault(null)

    override suspend fun <T> findAndModify(query: Query, update: Update, options: FindAndModifyOptions, entityClass: Class<T>): T? =
            reactiveMongoOperations.findAndModify(query, update, options, entityClass).awaitFirstOrDefault(null)

    override suspend fun <T> findAndModify(query: Query, update: Update, options: FindAndModifyOptions, entityClass: Class<T>, collectionName: String): T? =
    ...
    override suspend fun upsert(query: Query, update: Update, entityClass: Class<*>, collectionName: String): UpdateResult? =
    ...
    override suspend fun updateFirst(query: Query, update: Update, entityClass: Class<*>, collectionName: String): UpdateResult? =
    ...
    override suspend fun updateMulti(query: Query, update: Update, entityClass: Class<*>, collectionName: String): UpdateResult? =
